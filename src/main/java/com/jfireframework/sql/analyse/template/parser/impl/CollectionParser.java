...
import com.jfireframework.sql.analyse.template.execution.impl.CollectionExecution;
...
public class CollectionParser extends TemplateParser
{
	...
	public int parse(String sentence, int offset, Deque<Execution> executions, Template template, StringCache cache, Invoker next)
	{
		...
		Execution execution = new CollectionExecution(Expression.parse(sentence.substring(start, offset)));
