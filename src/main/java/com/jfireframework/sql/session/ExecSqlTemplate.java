...
public class ExecSqlTemplate
{
	...
	public static Object pageQuery(SqlInterceptor[] interceptors, final PageParse parse, final Page pageStore, final ResultSetTransfer transfer, final Connection connection, String sql, Object... params)
	{
		return execSql(new ExecStatement() {
			...
			public PreparedStatement exec(String sql, Object... params) throws Exception
			{
				if (pageStore.isFetchSum())
				{
					...
					List<?> list = transfer.transferList(executeQuery);
					pageStore.setData(list);
	...
	@SuppressWarnings("unchecked")
	public static List<Object> queryList(SqlInterceptor[] interceptors, final ResultSetTransfer transfer, final Connection connection, String sql, Object... params)
	{
		return (List<Object>) execSql(new ExecStatement() {
			List<Object> result;
