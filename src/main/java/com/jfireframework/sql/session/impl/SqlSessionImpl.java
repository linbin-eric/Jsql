...
public class SqlSessionImpl implements SqlSession
{
    ...
    {
        return ExecSqlTemplate.queryOne(sqlInterceptors, transfer, connection, sql, params);
    }
    
    @Override
    public <T> List<T> queryList(ResultSetTransfer transfer, String sql, Object... params)
    {
        return ExecSqlTemplate.queryList(sqlInterceptors, transfer, connection, sql, params);
    }
    
    @Override
    public <T> List<T> queryList(ResultSetTransfer transfer, String sql, Page page, Object... params)
    {
        return ExecSqlTemplate.pageQuery(sqlInterceptors, pageParse, page, transfer, connection, sql, params);
    }
    
    @Override
    public int update(String sql, Object... params)
    {
        return ExecSqlTemplate.update(sqlInterceptors, connection, sql, params);
    }
