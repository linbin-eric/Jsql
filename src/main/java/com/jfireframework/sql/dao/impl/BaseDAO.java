...
public abstract class BaseDAO implements Dao
{
	 ...
	 */
	@Override
	public void initialize(TableMetaData metaData, SqlInterceptor[] sqlInterceptors, SessionfactoryConfig config, PageParse pageParse)
	{
		...
		strategyOperation = new StrategyOperationImpl(entityClass, allColumns, config, sqlInterceptors, tableName, pageParse);
	}
	...
	public void save(Object entity, Connection connection)
	{
		...
		if (idValue == null)
		{      
			idValue = autoGeneratePkInsert(entity, connection);
			unsafe.putObject(entity, pkColumnOffset, idValue);
		}
		else
		{
	...
	protected abstract Object autoGeneratePkInsert(Object entity, Connection connection);
